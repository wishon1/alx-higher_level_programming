...
class Square(Rectangle):
    ...
    @property
    def size(self):
        """retrieve the height which is thesame as the width or
        height in the square"""
        return self.width

    @size.setter
    def size(self, value):
        """set the size.(note value is just a placeholder, any variable
            could be used. use of the name value is just a common convention
            to make code more readable. value represent the new size been
            assigned to the square)
        """
        self.width = value
        self.height = value
